...
# save histograms of weighted and normal correlations
...
print(corSummary)
saveRDS(corSummary,file=paste0(task.id,"_corSummary_",     realm, "_" , Taxon1, "_" ,Taxon2, ".rds"))
saveRDS(all.ests,file=paste0(task.id,"_slopeEstimates_",    realm, "_" , Taxon1,"_",Taxon2,".rds"))
